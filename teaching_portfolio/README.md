...
- CSCI-1200 [Data Structures](https://www.cs.rpi.edu/academics/courses/spring23/csci1200/): Syllabus/Course Calendar links publicly accesible. Objects/ADTs, C++ STL (`vector`, `list`, `map`, `unordered_map`, `priority_queue`), our own templated implementation of common STL classes, explicit memory management, debugging, inheritance
...
- CSCI-4220 [Network Programming](https://www.cs.rpi.edu/~holzbh/NetProg21/index.php): `fork()`, POSIX threads, C and Python socket programming, gRPC, TFTP, P2P, security, TLS overview
